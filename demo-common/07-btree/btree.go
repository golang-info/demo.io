...
/*
	https://github.com/cizixs/go-algorithms/blob/master/binarysearchtree/btree.go
*/

// Node represeents a tree node
...
// FindMax returns the bigest element in tree
...
// Walk function call `f` on every node value
...
type BinarySearchTree struct {
	...
	nodeNum int // nodes number: new many nodes are in the tree
}
...
// Inssert an element into the tree
...
// FindMax returns the biggest element tree
...
// - Node has tewo children, replace the leftmost node of the right part whith current node,
